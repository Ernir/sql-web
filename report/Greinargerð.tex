...
Allar tæknilausnir sem vefurinn notar eru opnar og ókeypis, líkt og kóði vefsins sjálfs. Um tæknilausnir má lesa nánar í \ref{sec:third-party-tech}.
...
Meðal afleiðinga þess er að allt efni vefsins breytanlegt af notendum hans, í samræmi við skilmála opins efnisleyfis (\ref{code:license}). Sérstakar viðbætur (\ref{sec:markdown-additions}) voru gerðar til að gera efnissmíði við hæfi kennsluvefsins auðveldari.
